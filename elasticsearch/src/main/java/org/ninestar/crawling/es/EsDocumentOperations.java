...
import org.ninestar.crawling.data.*;
import org.ninestar.crawling.es.model.DateHistogramValue;
...
public class EsDocumentOperations extends BaseElasticOps {
    ...
    public static final String CATEGORIES_FIELD = "name";
    public static final String DUPLICATE_OF_FIELD = "duplicate_of";
    /*Added Modification to more field*/
...
//    public static final String ARTICLE_KEYWORDS = "article_keywords";
    ...
    private static final Set<String> DEFAULT_FIELDS = Sets.newHashSet(
            ...
            STATUS_FIELD, APP_IDS_FIELD, CATEGORIES_FIELD, DESC_FIELD, LANGUAGE_CODE, META_KEYWORDS, IMAGES_URL);
    ...
    private void applyFields(XContentBuilder builder, HttpArticle article, Map<String, Object> fields) throws IOException {
        ...
        applyField(builder, LANGUAGE_FIELD, fields, article.getLanguage_code());
        applyField(builder, LANGUAGE_CODE, fields, article.getLanguage_code());
        ...
        applyField(builder, DESC_FIELD, fields, article.getDescription());
        applyField(builder, META_KEYWORDS, fields, article.getMeta_keywords());
        ...
        applyField(builder, IMAGES_URL, fields, article.getImages_url());
    ...
    protected HttpArticle mapToHttpArticle(Map<String, Object> source) {
        ...
        ha.setCategories(Objects.toString(source.get(CATEGORIES_FIELD)));
        ha.setImages_url(Objects.toString(source.get(IMAGES_URL)));
        ha.setDescription(Objects.toString(source.get(DESC_FIELD), null));
        ha.setLanguage_code(Objects.toString(source.get(LANGUAGE_CODE), null));
        ha.setMeta_keywords(Objects.toString(source.get(META_KEYWORDS), null));
