...
import static org.ninestar.crawling.es.EsDataParser.falseOrBoolean;
    ...
    public void save(HttpSource source) {
        try {
            ...
            XContentBuilder xContentBuilder = jsonBuilder()
                    ...
                    .field("description_selector", Utils.listToText(source.getdescriptionSelector()))
                    .field("keywords_selector", Utils.listToText(source.getKeywordsSelector()))
//
//                  .field("language_code", source.getlangcode() != null ? source.getlangcode().trim() : null)
////
                    //
//                      .field("meta_keywords", Utils.listToText(source.getMetaKW()))
//                      .field("images_url", Utils.listToText(source.getImageurl()))
                    .endObject();
...
//        hs.setlangcode(Objects.toString(source.get("language_code"), null));
        hs.setdescriptionSelector(DataUtils.parseStringList(source.get("description_selector")));
//        hs.setMetaKW(DataUtils.parseStringList(source.get("meta_keywords")));
        hs.setKeywordsSelector(DataUtils.parseStringList(source.get("keywords_selector")));
//        hs.setImageurl(DataUtils.parseStringList(source.get("images_url")));
        return hs;
    }
