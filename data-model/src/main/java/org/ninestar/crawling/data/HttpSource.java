...
public class HttpSource implements Serializable {
    ...
    private List<String> descriptionSelector;
    private List<String> KeywordsSelector;
//    private String langcode;
//    private List<String> MetaKW;
//    private List<String> imageurl;

    public List<String> getKeywordsSelector() {
        return KeywordsSelector;
    }

    public void setKeywordsSelector(List<String> keywordsSelector) {
...
//    }
    ...
    public List<String> getdescriptionSelector() {
        return descriptionSelector != null ? descriptionSelector : emptyList();
    }

    public void setdescriptionSelector(List<String> descriptionSelector) {
...
//    public List<String> getMetaKW() {
//        return MetaKW != null ? MetaKW : emptyList();
//    }
//
//    public void setMetaKW(List<String> MetaKW) {
//        this.MetaKW = MetaKW;
//    }
    ...
    public boolean equals(Object o) {
        ...
        return enabled == that.enabled &&
                ...
                Objects.equals(descriptionSelector, that.descriptionSelector)&&
                Objects.equals(KeywordsSelector, that.KeywordsSelector)
                ;
    }

    @Override
    public int hashCode() {
        return Objects.hash(name, url, timezone, enabled, discoveryEnabled, language, urlRecrawlDelayInSecs, sitemapRecrawlDelayInSecs, feedRecrawlDelayInSecs, urls, sitemaps, feeds, categories, appIds, urlFilters, urlNormalizers, titleSelectors, dateSelectors, dateRegexps, textSelectors, textNormalizers, dateFormats,descriptionSelector,KeywordsSelector);
    }
}