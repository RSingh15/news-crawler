package org.ninestar.crawling.adminui.view.sourcetest;

import com.vaadin.data.util.BeanItemContainer;
import com.vaadin.data.util.GeneratedPropertyContainer;
import com.vaadin.ui.*;
import com.vaadin.ui.renderers.HtmlRenderer;
import org.ninestar.crawling.adminui.utils.GridUtils.UrlToLinkConverter;
import org.ninestar.crawling.adminui.view.BaseView;
...
public class HttpSourceTestsView extends BaseView {
    ...
    public HttpSourceTestsView() {
        ...
        testAllButton.addClickListener(event -> {
            try {
                testAll();
            } catch (IOException e) {
                e.printStackTrace();
