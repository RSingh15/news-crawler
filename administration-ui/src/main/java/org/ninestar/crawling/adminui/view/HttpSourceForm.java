...
import org.ninestar.crawling.es.Utils;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import static org.ninestar.crawling.es.Utils.linesToList;
...
public class HttpSourceForm extends FormLayout {
    ...
    private TextArea description = new TextArea("Decription Selectors");
    private TextArea language_code = new TextArea("Default Language");
    private TextArea meta_keywords = new TextArea("meta_keywords");
    private TextArea keywords_selector = new TextArea("keywords_selector");
    private TextArea images_url = new TextArea("images_url");
    ...
    public HttpSourceForm() {
        ...
        language_code.setSizeFull();
//        language_code.setMaxLength(2);
        ...
        meta_keywords.setSizeFull();
        keywords_selector.setSizeFull();
        images_url.setSizeFull();
        ...
        addComponents(urlField, textField,
                ...
                dateSelectorsField, dateRegexpsField, dateFormatsField,description,meta_keywords,keywords_selector,images_url,language_code);
    ...
    void edit(HttpSource data) {
        if (data != null) {
            ...
            description.setValue(Utils.listToText(data.getdescriptionSelector()));
            description.setInputPrompt("e.g. a-->>b");
            keywords_selector.setValue(Utils.listToText(data.getKeywordsSelector()));
    ...
    public void reset() {
        ...
        urlFiltersField.setInputPrompt("e.g. +^http://www.thesun.co.uk/.*\ne.g. -.*apache.*");
        ...
        meta_keywords.setValue("");
        keywords_selector.setValue("");
        language_code.setValue("");
        images_url.setValue("");
    }
    ...
    private HttpSource mapFieldsToSource() {
        ...
        data.setdescriptionSelector(linesToList(description.getValue()));
        data.setKeywordsSelector(linesToList(keywords_selector.getValue()));
